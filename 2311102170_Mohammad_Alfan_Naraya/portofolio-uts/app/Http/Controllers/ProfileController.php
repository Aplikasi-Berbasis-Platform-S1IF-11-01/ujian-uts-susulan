...
use Illuminate\Routing\Controller as BaseController; // Solusi untuk error "Controller not found"
...
class PortfolioController extends BaseController
{
    ...
    // --- LOGIC PROFILE (Ref: image_828aab.png) ---
    ...
    // --- LOGIC SKILLS (Ref: image_828ae7.png) ---
    ...
    // --- LOGIC PROJECTS (Ref: image_828b09.png) ---
    ...
    public function updateProject(Request $request, $id)
    {
        ...
        if ($request->hasFile('gambar_project')) {
            if ($project->gambar_project) { 
                Storage::delete('public/' . $project->gambar_project); 
            }
            $project->gambar_project = $request->file('gambar_project')->store('projects', 'public');
        }
    ...
    // API UNTUK HALAMAN DEPAN (Welcome Page)
