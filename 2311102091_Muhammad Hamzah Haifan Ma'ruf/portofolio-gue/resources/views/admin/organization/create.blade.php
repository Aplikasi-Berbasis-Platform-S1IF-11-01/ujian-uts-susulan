...
@section('content')
    <div style="max-width: 800px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:25px; gap:20px; flex-wrap:wrap;">
            <div>
                <h1 style="margin:0; font-size:30px; color:#fff;">Tambah Organization</h1>
                <p style="margin-top:8px; color:#9ca3af;">Tambahkan data organization baru ke landing page.</p>
            </div>
