...
@section('content')
    <div style="max-width: 800px;">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:25px; gap:20px; flex-wrap:wrap;">
            <div>
                <h1 style="margin:0; font-size:30px; color:#fff;">Edit Education</h1>
                <p style="margin-top:8px; color:#9ca3af;">Ubah data education pada landing page.</p>
            </div>
        ...
        <div style="background:#181818; border:1px solid #2e2e2e; border-radius:20px; padding:28px;">
            <form action="{{ route('admin.education.update', $education->id) }}" method="POST">
                ...
                <div style="margin-bottom:20px;">
                    ...
                    <input type="text" id="major" name="major" value="{{ old('major', $education->major) }}"
                           style="width:100%; padding:14px 16px; border-radius:12px; border:1px solid #3a3a3a; background:#101010; color:#fff; outline:none;">
                </div>
                ...
                <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(220px, 1fr)); gap:20px; margin-bottom:24px;">
                    <div>
                        ...
                        <input type="text" id="start_year" name="start_year" value="{{ old('start_year', $education->start_year) }}"
                               style="width:100%; padding:14px 16px; border-radius:12px; border:1px solid #3a3a3a; background:#101010; color:#fff; outline:none;">
                    </div>

                    <div>
                        <label for="end_year" style="display:block; margin-bottom:10px; color:#fff; font-weight:600;">End Year</label>
                        <input type="text" id="end_year" name="end_year" value="{{ old('end_year', $education->end_year) }}"
                               style="width:100%; padding:14px 16px; border-radius:12px; border:1px solid #3a3a3a; background:#101010; color:#fff; outline:none;">
                    </div>
                </div>
